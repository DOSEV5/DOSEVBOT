    ...
    if (message.member.roles.cache.some((r) => r.name === "Member")) {
      const exampleEmbed = {
        ...
        fields: [
          ...
          {
            name: "Команда .youtube2",
            value: "Тя ще ви даде линк за моят втори ютюб канал.",
          },
          {
            name: "Команда .freegames",
            value: "Тя ще ви даде линк за сайт за безплатни игри (без вируси).",
          },
          {
            name: "Команда .invite",
            value:
              "Ще ви даде линк за [дискорд сървърът ми](https://discord.gg/T9qYz3G).",
          },
          {
            name: "Команда .help",
